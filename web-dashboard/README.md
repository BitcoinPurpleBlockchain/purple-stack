# BitcoinPurple Network Dashboard

Modern web dashboard for monitoring BitcoinPurple Node and ElectrumX Server statistics.

## Features

- **Real-time Monitoring**: Auto-refresh every 10 seconds
- **BitcoinPurple Node Stats**: Block height, difficulty, connections, sync progress
...
- `GET /api/bitcoinpurple/info` - BitcoinPurple node information
